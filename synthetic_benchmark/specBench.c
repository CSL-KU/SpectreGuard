...
int main( int argc, char ** argv )
{
    ...
    AES_KEY * my_aes_key;
    char aes_key_value[] = "01234567890123456789012345678901";
    
    unsigned int random[] = {1357,
    ...
    plain_text_orig.length = 1600;
    plain_text_orig.mask = 0x7FF;
    plain_text_orig.data = plain_text_orig_data;
    
    plain_in.length = 8192;
    plain_in.mask = 0x1FFF;
    ...
    for( i = 0; i < 1600; i++ )
    {
        plain_in_data[i] = plain_text_orig_data[i];
    }
