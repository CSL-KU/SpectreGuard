set terminal pdfcairo font "Gill Sans,16" size 14.0,3.5 linewidth 2 rounded #fontscale 1.0
...
set xtics nomirror rotate by -40 scale 0 font ",18"
set ylabel "Normalized Execution Time" offset 2
set style data histogram
set key left height -0.5 
